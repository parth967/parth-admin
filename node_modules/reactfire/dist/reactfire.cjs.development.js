...
function FirebaseAppProvider(props) {
  ...
  return React.createElement(FirebaseAppContext.Provider, {
    value: firebaseApp
  }, React.createElement(SuspenseEnabledContext.Provider, Object.assign({
...
function useUser(auth, options) {
  ...
  var observable$ = auth$1.user(auth);
...
function useDatabaseObject(ref, options) {
  ...
  var observable$ = database$1.object(ref);
  return useObservable(observableId, observable$, options);
} // ============================================================================
...
function objectVal(query, keyField) {
  return database$1.object(query).pipe(operators.map(function (change) {
...
function useDatabaseList(ref, options) {
  ...
  var observable$ = database$1.list(ref);
...
function useDatabaseListData(ref, options) {
  ...
  var observable$ = database$1.listVal(ref, idField);
  return useObservable(observableId, observable$, options);
}
...
function useFirestoreDoc(ref, options) {
  ...
  var observable$ = firestore$1.doc(ref);
  return useObservable(observableId, observable$, options);
}
/**
...
function useFirestoreDocOnce(ref, options) {
  ...
  var observable$ = firestore$1.doc(ref).pipe(operators.first());
  return useObservable(observableId, observable$, options);
}
/**
 * Suscribe to Firestore Document changes
...
function useFirestoreDocData(ref, options) {
  ...
  var observable = firestore$1.docData(ref, idField);
  return useObservable(observableId, observable, options);
}
/**
 * Get a firestore document and don't subscribe to changes
...
function useFirestoreDocDataOnce(ref, options) {
  ...
  var observable$ = firestore$1.docData(ref, idField).pipe(operators.first());
  return useObservable(observableId, observable$, options);
}
/**
...
function useFirestoreCollection(query, options) {
  ...
  var observable$ = firestore$1.fromCollectionRef(query);
  return useObservable(observableId, observable$, options);
}
/**
...
function useFirestoreCollectionData(query, options) {
  ...
  var observable$ = firestore$1.collectionData(query, idField);
  return useObservable(observableId, observable$, options);
}
...
function useStorageDownloadURL(ref, options) {
  ...
  var observable$ = storage$1.getDownloadURL(ref);
  return useObservable(observableId, observable$, options);
}
...
function StorageFromContext(props) {
  ...
  return React.createElement(INTERNALStorageImage, Object.assign({}, props));
}
...
function StorageImage(props) {
  ...
  if (storage) {
    ...
    return React.createElement(StorageFromContext, Object.assign({}, props));
  }
}
