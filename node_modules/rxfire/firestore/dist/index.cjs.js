...
function snapToData(snapshot, idField) {
    var _a;
    return tslib.__assign(tslib.__assign({}, snapshot.data()), (idField ? (_a = {}, _a[idField] = snapshot.id, _a) : null));
}
...
function sliceAndSplice(original, start, deleteCount) {
    ...
    returnArray.splice.apply(returnArray, tslib.__spreadArrays([start, deleteCount], args));
    return returnArray;
}
/**
...
function sortedChanges(query, events) {
    return collectionChanges(query, events).pipe(operators.scan(function (current, changes) {
...
function auditTrail(query, events) {
    return collectionChanges(query, events).pipe(operators.scan(function (current, action) { return tslib.__spreadArrays(current, action); }, []));
}
/**
